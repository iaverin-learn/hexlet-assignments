...
public class GuestsController {
    ...
    @PostMapping("")
    public GuestDTO createGuest(@Valid @RequestBody GuestDTO guestData) {
        
        var guest = guestMapper.map(guestData);
        var guestValidated = guestMapper.map(guest);
        var savedGuest = guestRepository.save(guestValidated);
